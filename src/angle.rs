...
// used in add impl.  There are a few edge cases here which warrant
// it being its own function
    ...
    match (a, b) {
        ...
        (Some(x), Some(y)) => {
            if x == 0 && y == 0 {
                ...
                None // because x and y are not 0 (see first condition), this wrapped into 0, meaning 2 pi.
            } else {
